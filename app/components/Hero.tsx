  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        {/* Tag */}
        <div className="fade-in fade-in-delay-1 inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-purple-700/50 bg-purple-950/30 text-purple-300 text-sm mb-8">
        ...
        <p className="fade-in fade-in-delay-3 text-lg sm:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          <span className="text-purple-400">Unity</span> and{" "}
          <span className="text-cyan-400">C#</span>. From roguelikes to
        ...
        <div className="fade-in fade-in-delay-4 flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="#projects"
            className="btn-glow px-8 py-3 rounded-full bg-purple-600 hover:bg-purple-500 text-white font-semibold text-sm tracking-wide transition-colors duration-200"
          >
            View My Games
          </a>
          <a
            href="#contact"
            className="btn-outline-glow px-8 py-3 rounded-full border border-cyan-700/60 text-cyan-400 font-semibold text-sm tracking-wide"
          >
            Get in Touch
          </a>
        </div>
