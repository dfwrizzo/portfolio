  ...
  return (
    <div className="flex items-center gap-2.5">
      <div className="w-10 h-10 rounded-xl bg-emerald-950/60 border border-emerald-800/40 flex items-center justify-center flex-shrink-0">
        <svg width="20" height="20" viewBox="0 0 32 32" fill="none" className="text-emerald-400">
      ...
      <div>
        ...
        <div className="text-emerald-400 text-xs">Studios</div>
      </div>
    </div>
  );
}
...
function MegaCatBadge() {
  return (
    <div className="flex items-center gap-2.5">
      <div className="w-10 h-10 rounded-xl bg-orange-950/60 border border-orange-800/40 flex items-center justify-center flex-shrink-0 overflow-hidden">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
      ...
      <div>
        ...
        <div className="text-orange-400 text-xs">Game Developer & Publisher</div>
      </div>
    </div>
  );
}