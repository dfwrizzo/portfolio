...
export default function Contact() {
  return (
    <section id="contact" className="py-20 px-6 bg-[#0d0d14]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="text-slate-500 mb-10">
            Open to game dev roles, freelance projects, and collaborations.
          </p>
      ...
      <div className="max-w-6xl mx-auto mt-20 pt-8 border-t border-slate-800/50 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-slate-600">
        <span>© 2026 Angelo Castillo</span>
        <span>
